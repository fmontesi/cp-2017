...
public interface Stats
{
	 ...
	 * 
	 * Be careful:
	 * If the number was not found at all, this method should return 0.
	 */
	public int occurrences( int number );
	
	/**
	 * Returns the list of files whose averages (see findAll for the definition of average) are not greater than max.
	 */
